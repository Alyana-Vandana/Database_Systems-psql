...
/**
 * Class to display Course Prerequisites for input DEPT_CODE and COURSE_
 */
public class DisplayClassPrerequisite {

    /**
     * Method to return Prerequisite courses for input DEPT_CODE and COURSE_
     * @param conn
     * @param deptCode
     * @param courseNumber
     * @return
    ...
    public static List<String> getCoursePrerequisite(Connection conn, String deptCode, int courseNumber) throws SQLException {
        // Local variable
        String query = "begin student_registration_system.class_prereq(?, ?, ?); end;";
        ...
        // Set dept_code and course_ as input parameter
